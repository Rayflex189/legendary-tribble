...
class UserRegistrationForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for field in self.fields:
            if field not in ['email', 'first_name', 'last_name', 'phone']:
...
class UserProfileForm(forms.ModelForm):
    class Meta:
        model = User
        fields = ('first_name', 'last_name', 'phone', 'address', 'city', 'state', 'country', 'postal_code')
        widgets = {
...
class ExtendedProfileForm(forms.ModelForm):
    class Meta:
        model = UserProfile
        fields = ('company_name', 'tax_id', 'preferred_payment_method')
        widgets = {
